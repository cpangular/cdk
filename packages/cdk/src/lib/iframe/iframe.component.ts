...
export class IFrameComponent implements OnInit {
  ...
  constructor(private readonly domSanitizer: DomSanitizer, private readonly element: ElementRef<HTMLElement>) {}

  private get iframe(): HTMLIFrameElement {
    return this.element.nativeElement.querySelector('iframe') as HTMLIFrameElement;
  }
