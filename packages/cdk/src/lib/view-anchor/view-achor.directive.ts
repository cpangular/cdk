...
export class ViewAnchorDirective implements IViewAnchorDirective, OnChanges, OnDestroy {
  ...
  //private _viewRefs: Map<IViewDirective, EmbeddedViewRef<any>> = new Map();
  ...
  private removeViewNodes(view: IViewDirective) {
    view.getViewNodes().forEach((n) => n.remove());
