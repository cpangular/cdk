export class ApplicationViewAnchors{
    ...
    static readonly notices = Symbol("Application Notices Anchor");
    ...
    static readonly panels = class PanelAnchors {
        static readonly top = Symbol("Application Shell Top Panel Anchor");
        static readonly bottom = Symbol("Application Shell Bottom Panel Anchor");
        static readonly left = Symbol("Application Shell Left Panel Anchor");
        static readonly right = Symbol("Application Shell Right Panel Anchor");
    }
}