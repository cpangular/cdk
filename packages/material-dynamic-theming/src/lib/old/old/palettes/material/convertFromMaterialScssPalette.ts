...
export function convertFromMaterialScssPalette(palette: IMaterialScssPalette): IMaterialPalette {
  const result = {} as any;
  for (const key in palette) {
    if (key !== 'contrast' && Object.prototype.hasOwnProperty.call(palette, key)) {
